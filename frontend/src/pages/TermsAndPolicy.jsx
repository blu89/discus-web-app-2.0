        ...
        {activeTab === 'terms' && (
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                By accessing and using Imperial Discus (the "Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Permission is granted to temporarily download one copy of the materials (information or software) on Imperial Discus for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
                <li>Modifying or copying the materials</li>
                <li>Using the materials for any commercial purpose or for any public display</li>
                <li>Attempting to decompile or reverse engineer any software contained on Imperial Discus</li>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                The materials on Imperial Discus are provided on an 'as is' basis. Imperial Discus makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                In no event shall Imperial Discus or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Imperial Discus, even if Imperial Discus or an authorized representative has been notified orally or in writing of the possibility of such damage.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                The materials appearing on Imperial Discus could include technical, typographical, or photographic errors. Imperial Discus does not warrant that any of the materials on Imperial Discus are accurate, complete, or current. Imperial Discus may make changes to the materials contained on its website at any time without notice.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Imperial Discus has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Imperial Discus of the site. Use of any such linked website is at the user's own risk.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Imperial Discus may revise these terms of service for its website at any time without notice. By using this website, you are agreeing to be bound by the then current version of these terms of service.
              </p>
            </section>
        ...
        {activeTab === 'privacy' && (
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Imperial Discus ("we", "our", or "us") operates the Imperial Discus website. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Imperial Discus uses the collected data for various purposes:
              </p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <p className="text-gray-900 dark:text-white font-semibold">Email: privacy@Imperial Discus.com</p>
        ...
        {activeTab === 'shipping' && (
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <p className="text-gray-900 dark:text-white font-semibold">Email: returns@Imperial Discus.com</p>
                <p className="text-gray-600 dark:text-gray-400">Phone: +1 (555) 123-4567</p>
      ...
      <section className="bg-gray-50 dark:bg-gray-900 py-8 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            By using Imperial Discus, you agree to comply with our Terms of Service, Privacy Policy, and Shipping & Returns Policy. If you do not agree with any of these policies, please do not use our service.
          </p>
          <a 
            href="/" 
