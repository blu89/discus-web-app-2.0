  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200">
      ...
      <section className="relative w-full h-64 md:h-96 overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 text-blue-500 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 p-1 rounded-full shadow-lg transition z-10"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 text-blue-500 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 p-1 rounded-full shadow-lg transition z-10"
