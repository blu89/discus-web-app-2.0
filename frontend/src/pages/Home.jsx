  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200">
      ...
      <section className="relative w-full h-96 overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 text-blue-500 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 p-3 rounded-full shadow-lg transition z-10"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 text-blue-500 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 p-3 rounded-full shadow-lg transition z-10"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg dark:shadow-gray-700 text-center transition">
              ...
              <p className="text-gray-600 dark:text-gray-400">Get served instantly at our location or Delivery across Cameroon.</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg dark:shadow-gray-700 text-center transition">
              <div className="text-4xl mb-4">🔒</div>
