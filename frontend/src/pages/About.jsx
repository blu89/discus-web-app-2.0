    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200">
      ...
      <section className="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">About Imperial Discus</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg leading-relaxed">
                Founded in 2020, Imperial Discus started with a simple mission: to provide customers with high-quality products at affordable prices. What began as a small startup has grown into a thriving e-commerce platform serving thousands of satisfied customers worldwide.
              </p>
              <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg leading-relaxed">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white">Why Choose Imperial Discus?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <section className="bg-blue-500 dark:bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Start shopping with Imperial Discus today and experience the difference</p>
          <a 
            href="/storefront" 
